    ...
    public void initialize(URL arg0, ResourceBundle arg1) {
    	...
    	for(int i=0; i<list.size()-1; i++) {
    		for(int j=i+1; j<list.size(); j++) {
    			if(list.get(j).getBview() > list.get(i).getBview()) {
    				if(list.get(j).getBview()>= boards[0].getBview()) boards[0]=list.get(j);
    				else if(list.get(j).getBview() >= boards[1].getBview()) boards[1]=list.get(j);
    			}else if(list.get(j).getBview() < list.get(i).getBview()) {
    				if(list.get(i).getBview()>= boards[0].getBview()) boards[0]=list.get(i);
    				else if(list.get(i).getBview() >= boards[1].getBview()) boards[1]=list.get(i);
    			}
    		}
    	}
